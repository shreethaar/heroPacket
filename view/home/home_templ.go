...
func ShowHome(csrfToken string, files []UploadedFile) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/home/home.templ`, Line: 75, Col: 60}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var3))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\"></form></div></div></nav><!-- Success Dialog --><div id=\"successDialog\" class=\"fixed inset-0 flex items-center justify-center hidden\"><div class=\"bg-gray-700 rounded-xl p-6 border border-gray-600 shadow-2xl\"><div class=\"flex items-center text-green-400 mb-4\"><svg class=\"h-6 w-6 mr-2\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M5 13l4 4L19 7\"></path></svg> <span class=\"text-lg font-semibold\">Upload Successful!</span></div><p class=\"text-gray-300\">Your PCAP file has been uploaded successfully.</p></div></div><!-- Form with success handling --><form id=\"uploadForm\" hx-post=\"/upload\" hx-encoding=\"multipart/form-data\" enctype=\"multipart/form-data\" method=\"POST\" class=\"hidden\" onsubmit=\"showSuccessDialog()\"><input type=\"file\" id=\"fileInput\" name=\"pcap-file\" accept=\".pcap,.pcapng\" onchange=\"document.getElementById(&#39;uploadForm&#39;).submit()\"> <input type=\"hidden\" name=\"_csrf\" value=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for _, file := range files {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/home/home.templ`, Line: 189, Col: 51}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/home/home.templ`, Line: 190, Col: 87}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/home/home.templ`, Line: 191, Col: 67}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/home/home.templ`, Line: 195, Col: 47}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var8))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "\" class=\"bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-600 transition-colors\">Analyze</button></td></tr>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		if len(files) == 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<tr><td colspan=\"4\" class=\"px-6 py-4 text-center text-white\">No PCAP files uploaded yet</td></tr>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</tbody></table></div></div></div></div></body>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
